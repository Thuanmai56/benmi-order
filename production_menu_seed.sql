-- Hạt giống Thực đơn Production tùy chỉnh
DELETE FROM menu_items WHERE tenant_id = 'benmi';
DELETE FROM menu_categories WHERE tenant_id = 'benmi';

INSERT INTO menu_categories (id, tenant_id, name, slug, sort_order) VALUES ('cat_small', 'benmi', 'Kích thước Nhỏ', 'small', 1);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('s1', 'benmi', 'cat_small', '清爽蔬食麵包', 56, 1);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('s2', 'benmi', 'cat_small', '燒肉', 56, 2);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('s3', 'benmi', 'cat_small', '火腿', 56, 3);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('s4', 'benmi', 'cat_small', '雞肉', 68, 4);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('s5', 'benmi', 'cat_small', '烤肉', 72, 5);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('s6', 'benmi', 'cat_small', '雙層烤肉', 78, 6);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('s7', 'benmi', 'cat_small', '綜合', 79, 7);

INSERT INTO menu_categories (id, tenant_id, name, slug, sort_order) VALUES ('cat_large', 'benmi', 'Kích thước Lớn', 'large', 2);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('l1', 'benmi', 'cat_large', '清爽蔬食麵包', 80, 1);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('l2', 'benmi', 'cat_large', '烤肉', 105, 2);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('l3', 'benmi', 'cat_large', '雙層烤肉', 115, 3);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('l4', 'benmi', 'cat_large', '綜合', 130, 4);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('l5', 'benmi', 'cat_large', '雞肉', 100, 5);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('l6', 'benmi', 'cat_large', '燒肉', 80, 6);
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('l7', 'benmi', 'cat_large', '火腿', 80, 7);
...
INSERT INTO menu_items (id, tenant_id, category_id, name, price, sort_order) VALUES ('c12', 'benmi', 'cat_combo', '假日滿足套餐', 100, 12);
